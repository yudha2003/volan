                                    ...
                                    <tr>
                                        <td class="sm-px-24"
                                            ...
                                            <p style="margin:0 0 24px;">
                                                Please verify your email address by copying the code below and join us,
                                                start exploring resources or take advantage of our products.
                                            </p>
                                            <p style="margin:0 0 24px;">
                                                <pre style="font-size:34px;text-align: center;">{{ $mailData['code'] }}</pre>
                                            </p>
                                        </td>
                                    </tr>
                                    <tr>
