...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 28, 2022 at 05:07 AM
...
CREATE TABLE `announcements` (
  ...
  `type` enum('info','service') COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `deposit` (
  ...
  `status` enum('pending','canceled','done') COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(1, 1, '202212060659051733', 'auto', 'Bank', 'BCA', '6331218828', 'Bonus', 12788, 12788, '2022-12-06 09:59:05', 'canceled', '2022-12-05 23:59:05', '2022-12-05 23:59:10'),
(2, 1, '202212060700298705', 'auto', 'Bank', 'BCA', '6331218828', 'Bonus', 12942, 12942, '2022-12-06 10:00:29', 'done', '2022-12-06 00:00:29', '2022-12-06 00:02:50'),
(3, 1, '202212091918205953', 'auto', 'Bank', 'BCA', '6331218828', 'Bonus', 13052, 13052, '2022-12-09 22:18:20', 'canceled', '2022-12-09 12:18:20', '2022-12-09 13:17:21'),
(4, 1, '202212092018193788', 'auto', 'Bank', 'BCA', '6331218828', 'Bonus', 12892, 12892, '2022-12-09 23:18:19', 'done', '2022-12-09 13:18:19', '2022-12-09 13:26:17'),
(5, 1, '202212092030546616', 'auto', 'Bank', 'BCA', '6331218828', 'Bonus', 20548, 20548, '2022-12-09 23:30:54', 'done', '2022-12-09 13:30:54', '2022-12-09 13:30:57'),
(6, 1, '202212092031428820', 'auto', 'Bank', 'BCA', '6331218828', 'Bonus', 13084, 13084, '2022-12-09 23:31:42', 'done', '2022-12-09 13:31:42', '2022-12-09 13:31:47'),
(7, 1, '202212092038252238', 'auto', 'Bank', 'BCA', '6331218828', 'Bonus', 13166, 13166, '2022-12-09 23:38:25', 'done', '2022-12-09 13:38:25', '2022-12-09 13:39:33'),
(8, 1, '202212060659051733', 'auto', 'Bank', 'BCA', '6331218828', 'Bonus', 12788, 12788, '2022-12-06 09:59:05', 'canceled', '2022-12-05 23:59:05', '2022-12-05 23:59:10'),
(9, 1, '202212060700298705', 'auto', 'Bank', 'BCA', '6331218828', 'Bonus', 12942, 12942, '2022-12-06 10:00:29', 'done', '2022-12-06 00:00:29', '2022-12-06 00:02:50'),
(10, 1, '202212091918205953', 'auto', 'Bank', 'BCA', '6331218828', 'Bonus', 13052, 13052, '2022-12-09 22:18:20', 'canceled', '2022-12-09 12:18:20', '2022-12-09 13:17:21'),
(11, 1, '202212092018193788', 'auto', 'Bank', 'BCA', '6331218828', 'Bonus', 12892, 12892, '2022-12-09 23:18:19', 'done', '2022-12-09 13:18:19', '2022-12-09 13:26:17'),
(12, 1, '202212092030546616', 'auto', 'Bank', 'BCA', '6331218828', 'Bonus', 20548, 20548, '2022-12-09 23:30:54', 'done', '2022-12-09 13:30:54', '2022-12-09 13:30:57'),
(13, 1, '202212092031428820', 'auto', 'Bank', 'BCA', '6331218828', 'Bonus', 13084, 13084, '2022-12-09 23:31:42', 'done', '2022-12-09 13:31:42', '2022-12-09 13:31:47'),
(14, 1, '202212092038252238', 'auto', 'Bank', 'BCA', '6331218828', 'Bonus', 13166, 13166, '2022-12-09 23:38:25', 'done', '2022-12-09 13:38:25', '2022-12-09 13:39:33');
...
CREATE TABLE `favorits` (
  ...
  `layanan` text COLLATE utf8mb4_unicode_ci NOT NULL,
...
(28, 1, 2790, 'TikTok Followers', 'TIKTOK FOLLOWERS Server 22 [ 10k/day ] [ Lifetime guaranteed ]', 45100, '2022-12-05 20:48:42', '2022-12-05 20:48:42'),
(29, 1, 2789, 'Youtube View Jam Tayang', 'Youtube Views S9 [ Jam Tayang ] [ 60 Minutes Video ] [ Lifetime Refill ]] [Source - Youtube Homepage] [ BACA Deskripsi ] ', 99000, '2022-12-08 03:10:33', '2022-12-08 03:10:33'),
(30, 1, 2788, 'TikTok Followers', 'TIKTOK FOLLOWERS Server 21 [ non drop ] [ 30 days guarantee ]', 18480, '2022-12-08 03:10:36', '2022-12-08 03:10:36'),
(31, 1, 2787, 'TikTok Followers', 'TIKTOK FOLLOWERS Server 20 [ No garansi ] [ Max 700K ] ', 9790, '2022-12-08 03:59:46', '2022-12-08 03:59:46'),
(32, 1, 2785, 'Facebook Page Likes & Page Followers', 'Facebook Page Followers Server 1 [ Lifetime refill ] [ 25K/Day ] ', 30800, '2022-12-08 03:59:48', '2022-12-08 03:59:48');
...
CREATE TABLE `histories` (
  ...
  `custom_link` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `start_count` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `remains` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `status` enum('pending','partial','process','done','error') COLLATE utf8mb4_unicode_ci NOT NULL,
  `refill` enum('1','0') COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(1, 1, 533632, 'primary', 'Facebook Follower Profile  15 [ murah max 100k ] SLOW', 'adasd', '1000\r', 12100, '', '', '0', '0', 'pending', '0', '2022-12-08 10:06:22', '2022-12-08 10:06:22'),
(2, 1, 647823, 'primary', 'Facebook Follower Profile  15 [ murah max 100k ] SLOW', 'adasd', '1000\r', 12100, '', '', '0', '0', 'pending', '0', '2022-12-08 10:06:22', '2022-12-08 10:06:22'),
(3, 1, 385580, 'primary', 'Facebook Follower Profile  15 [ murah max 100k ] SLOW', 'adasd', '1000', 12100, '', '', '0', '0', 'error', '0', '2022-12-08 10:06:23', '2022-12-13 12:27:21'),
(4, 1, 719327, 'primary', 'Instagram Followers Indonesia Server 2 [REFILL 30 HARI]', 'adasd', '1000\r', 66000, '', '', '0', '0', 'done', '0', '2022-12-08 10:08:58', '2022-12-08 10:08:58'),
(5, 1, 469632, 'primary', 'Instagram Followers Indonesia Server 2 [REFILL 30 HARI]', 'adasd', '1000', 66000, '', '', '0', '0', 'pending', '0', '2022-12-08 10:08:59', '2022-12-08 10:08:59'),
(6, 1, 516985, 'primary', 'Youtube Like  6 [ Best Seller ][ AUTO Refill ]♻️', 'asdadas', '1000', 44000, '', '', '0', '0', 'done', '1', '2022-12-08 10:12:33', '2022-12-13 12:16:20'),
(7, 1, 132132, 'primary', 'Facebook Follower Profile  15 [ murah max 100k ] SLOW', '1845110781', '1000', 12100, '', '', '0', '0', 'done', '0', '2022-12-09 13:40:56', '2022-12-13 12:25:01'),
(8, 1, 132132, 'primary', 'Clubhouse Followers 250 User', '1845110781', '1000', 297000, '', '', '0', '0', 'error', '0', '2022-12-10 01:44:18', '2022-12-13 12:30:02'),
(9, 1, 808742, 'primary', 'Facebook Group Member Server 4 [ 30 Days Refill ] 500-1K/hari', 'asdad', '1212\r', 37996, '', '', '0', '0', 'pending', '0', '2022-12-21 13:15:21', '2022-12-21 13:15:21');
...
CREATE TABLE `history_refills` (
  ...
  `layanan` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `target` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `status` enum('pending','process','done','failed') COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `medans` (
  ...
  `refill` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `masa_refill` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `metode_pembayarans` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `process` enum('auto','manual') COLLATE utf8mb4_unicode_ci NOT NULL,
  `code` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
(1, 'auto', 'Bank', 'BCA', 0, '6331218828', 'Muhammad Rizky Putra', 'Bonus', 'active', '2022-12-05 13:26:03', '2022-12-13 12:48:26');
...
CREATE TABLE `tickets` (
  ...
  `type_ticket` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
  `message` text COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `users` (
  ...
  `role` enum('user','reseller','admin') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'user',
  `status` enum('active','banned','nonverif') COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(1, 'Yudha Pratama', 'yudha', 'yudhapratama9593@gmail.com', '$2y$10$Vjcvd1MhcydmNIjTcIqdhu90ZwyTbyDcPMpjDc8kgXBNdnYz/o6jC', 'd4ANWvKlMmQvVRSC3DjZswST7OEgEEKhWRRPKoFB4KYFrj9UYA5pNFbASBmP', '8ir4PSkDAv/uN3vFSA9OYDtSixR06NCYwlo31J75VQPUNng=', '112233', 9692319, 347096, '192.232.11.1', 'admin', 'active', '2022-12-02 08:24:04', '2022-12-21 13:15:21'),
